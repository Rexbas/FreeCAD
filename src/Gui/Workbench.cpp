...
void StdWorkbench::setupContextMenu(const char* recipient, MenuItem* item) const
{
    if (strcmp(recipient,"View") == 0)
    {
        ...
        *item << "Std_ViewFitAll" << "Std_ViewFitSelection" << "Std_AlignToSelection" << "Std_ReverseAlignToSelection" << "Std_DrawStyle"
              << StdViews << "Separator"
...
MenuItem* StdWorkbench::setupMenuBar() const
{
    ...
    *axoviews << "Std_ViewIsometric"
    ...
    auto stdviews = new MenuItem;
    stdviews->setCommand("Standard &views");
    *stdviews << "Std_ViewFitAll" << "Std_ViewFitSelection" << "Std_AlignToSelection" << "Std_ReverseAlignToSelection" << axoviews
...
ToolBarItem* StdWorkbench::setupToolBars() const
{
    ...
    *macro << "Std_DlgMacroRecord" << "Std_DlgMacroExecute"
    ...
    view->setCommand("View");
    *view << "Std_ViewFitAll" << "Std_ViewFitSelection" << "Std_ViewGroup" << "Std_SelectionAlignmentGroup"
